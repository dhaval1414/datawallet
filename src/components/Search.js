...
export default class Search extends Component {
    ...
    async searchInOcean(e) {
        ...
        try {
            const url = `https://aquarius.${this.context.network}.oceanprotocol.com/api/v1/aquarius/assets/ddo/query?text=${this.state.searchQuery}&offset=500`
    ...
    renderResults() {
        return <AssetList data={this.state.searchResults} />
    }
    renderSearchSuccess() {
        return (
            <div>
        ...
        return (
            <>
                ...
                <p style={{ color: '#D06079' }}>
                    Oops! some error occured while publishing
                </p>
                <Button primary onClick={this.searchInOcean.bind(this)}>
                    Search Again
                </Button>
            </>
        )
    ...
    renderSearchInProgress() {
        return (
            <div>
                ...
                <p>{`Searching datasets for "${this.state.searchQuery}"`}</p>
            </div>
        )
    }
